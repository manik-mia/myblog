...
<div class="row article-row">
    ...
    <div class="col-3 p-0 pt-4 right-sidebar">
        ...
        <div class="accordion">
            ...
            <div class="accordion-content">
                <div class="tag">
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Officia placeat delectus amet porro quae quo nisi laborum, modi expedita, itaque veniam et, ut blanditiis reiciendis numquam id ipsum aliquid veritatis quasi dolor libero. Soluta quam in id fugiat tempora, blanditiis eaque ab fuga cum quidem quos possimus ipsam iusto voluptatibus.</p>
                </div>
            </div>
        </div>
    </div>
